...
function Home() {
  return (
    <div class="bg-black w-full h-screen" className="">
      {/** Section: NavBar */}
      <NavBar></NavBar>
      ...
      <section class="bg-black">
        <div class="border-2 border-black grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-10 xl:gap-0 lg:py-2 lg:grid-cols-12">
            <div class="px-4 py-8 mr-auto place-self-center lg:col-span-7">
                <h1 class="text-white max-w-1xl mb-4 text-4xl font-semibold tracking-tight leading-none md:text-xl xl:text-6xl dark:text-white">
    ...
    <section class="bg-black">
      <div class="border-2 border-black max-w-screen-xl px-4 py-8 mx-auto lg:gap-10 xl:gap-0 lg:py-2 lg:grid-cols-12">
        <h1 class="mt-10 text-center max-w-1xl mb-4 text-3xl text-white font-semibold tracking-tight leading-none md:text-2xl xl:text-6xl dark:text-white">
        ...
        <div class="px-4 py-8 mr-auto mb-100 place-self-center lg:col-span-12 mx-10 space-y-4 lg:space-y-0 lg:gap-4 lg:grid lg:grid-cols-3">
          <div class="w-80 rounded hover:shadow-2xl">
              <img src="/home3.webp"  alt="photo1"></img>
              <h1 class="mt-2 text-center text-white font-bold max-w-s text-s font-light tracking-tight leading-none md:text-lg xl:text-xl dark:text-white">
                Join a DAO
              </h1>
          </div>
          <div class="w-80 rounded hover:shadow-2xl">
              <img src="/home2.png" alt="photo2"></img>
              <h1 class="mt-2 text-center text-white font-bold max-w-s text-s font-light tracking-tight leading-none md:text-lg xl:text-xl dark:text-white">
    ...
    <section class="bg-black">
      <div class="border-2 border-black grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-10 l:gap-0 m:py-2 lg:grid-cols-12">
        ...
        <div class="px-4 py-8 mr-auto place-self-center lg:col-span-7">
            <p class="max-w-2xl mb-8 font-semibold text-red-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              CONTRIBUTE-TO-EARN
            </p>
            <h1 class="max-w-1xl mb-4 text-4xl text-white font-bold tracking-tight leading-none md:text-xl xl:text-6xl dark:text-white">
              Earn in Web 3.0
            </h1>
    ...
    <section class="bg-black">
      <div class="border-2 border-black max-w-screen-xl px-4 py-8 mx-auto lg:gap-10 xl:gap-0 lg:py-2 lg:grid-cols-12">
        <h1 class="mt-10 text-center text-white max-w-1xl mb-4 text-3xl font-bold tracking-tight leading-none md:text-2xl xl:text-6xl dark:text-white">
        ...
        <div class="px-4 py-8 mr-auto mb-100 place-self-center lg:col-span-12  space-y-4 lg:space-y-0 lg:gap-4 lg:grid lg:grid-cols-4">
          <div class="w-60 rounded hover:shadow-2xl">
              ...
              <h1 class="mt-2 text-gray-200 text-center font-light max-w-s text-s font-light tracking-tight leading-none md:text-lg xl:text-xl dark:text-white">
          ...
          <div class="w-60 rounded hover:shadow-2xl">
              <img src="/home8.webp"alt="Verification"></img>
              <h1 class="py-2 mt-0 text-gray-200 text-center font-light max-w-s text-s font-light tracking-tight leading-none md:text-lg xl:text-xl dark:text-white">
                The DAO will verify the tasks completion and that you qualify to receive funds.
              </h1>
          </div>
          <div class="w-60 rounded hover:shadow-2xl">
              <img src="/home9.webp" alt="Receive Rewards"></img>
              <h1 class="mt-1 text-gray-200 text-center font-light max-w-s text-s font-light tracking-tight leading-none md:text-lg xl:text-xl dark:text-white">
    ...
    <section class="bg-black">
      <div class="border-2 border-black grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-0 l:gap-0 m:py-2 lg:grid-cols-12"> 
        <div class="px-4 py-8 mr-auto place-self-center lg:col-span-7">
            <p class="max-w-2xl mb-6 font-semibold text-red-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              START YOUR JOURNEY TODAY.
            </p>
            <h1 class="max-w-1xl mb-4 text-4xl text-white font-extrabold tracking-tight leading-none md:text-xl xl:text-6xl dark:text-white">
              Launch a Project!
            </h1>
            <p class="max-w-2xl mb-6 font-light text-gray-200 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
        ...
        <div class="w-100 lg:mt-0 lg:col-span-5 xl:flex">
          <img src="/home10.webp" alt="Earn"></img>
        </div>           
      </div>
    </section>
    </div>
